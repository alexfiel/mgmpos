    ...
    Public Sub runtransaction_termpayment()
        ...
        Try
            ...
            For Each row As DataGridViewRow In frmPOS.DGProduct.Rows
                ...
                myCommand.ExecuteNonQuery()
            Next
            myCommand.CommandText = "INSERT INTO `newpost_database`.`costumer_ledger` (`custobjid`, `transactionID`, `terms`, `transactionDate`, `term_due_date`, `trans_type`, `dr`) VALUES (@objid, @transactionID, @terms, @transDate, @termDueDate, @transType, @dr);"
            With myCommand
                .Parameters.Clear()
