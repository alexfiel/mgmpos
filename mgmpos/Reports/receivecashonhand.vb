...
Public Class receivecashonhand
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "mgmpos.receivecashonhand.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreceivecashonhand
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As receivecashonhand = New receivecashonhand()
        rpt.Site = Me.Site
        Return rpt
    End Function
