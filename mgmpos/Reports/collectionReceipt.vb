...
Public Class collectionReceipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "mgmpos.collectionReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_trans_no() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcollectionReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As collectionReceipt = New collectionReceipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
